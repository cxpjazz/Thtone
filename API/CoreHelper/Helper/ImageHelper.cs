    ...
    public class ImageHelper
    {
        ...
        public static bool MakeThumbImage(string file, int thumbnailMode)
        {
            ...
            try
            {
                if (thumbnailMode == 2)
                {
                    ...
                    Image image1 = ImageHelper.CutImg(image, 150, 150, ImageHelper.CutMode.AUTO, true);
                ...
                else if (thumbnailMode == 3)
                {
                    ...
                    image1.Save(file + ".150150.jpg", ImageFormat.Jpeg);
                    image1.Dispose();
                    Image image2 = ImageHelper.CutImg(image, 350, 350, ImageHelper.CutMode.AUTO, true);
                ...
                {
                    //CoreHelper.EventLog.Log("准备生成小图");
                    //自定义长宽缩放,长宽值以字符串长度/2
                    ...
                    if (System.IO.File.Exists(saveFile))
                        return true;
                    Image image = Image.FromFile(file);
                    Image image1 = ImageHelper.CutImg(image, w, h, ImageHelper.CutMode.AUTO, true);
        ...
        public static Image MakeWaterMark(Image source, Image waterMarkImage)
        {
            ...
            if (height > source.Height / 2)
                height = height / 2;
            g.DrawImage(waterMarkImage, new Rectangle(x, y, width, height));
            g.Dispose();
            return source;
        }
    }
